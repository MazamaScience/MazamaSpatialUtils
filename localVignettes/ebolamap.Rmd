...
```{r ebolaCountries, fig.width=7, fig.height=7,out.width=500, out.height=500, fig.align='center'}
library(MazamaSpatialUtils)
library(sp)
setSpatialDataDir('~/SpatialData') # Use your own Spatial Data directory
...
```{r ebolaCaseRate, fig.width=7, fig.height=10, out.width=500, out.height=714, fig.align='center'}
