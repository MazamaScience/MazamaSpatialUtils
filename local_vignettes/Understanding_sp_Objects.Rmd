...
To work efficiently with the `simple features data frame` (SFDF) objects used in
...
Each `simple features data frame` is an **S4** object with a 1:1 relationship 
...
```{r SFDF, fig.width = 7, fig.height = 7}
