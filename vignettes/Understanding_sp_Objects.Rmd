...
object classes that underly the **sp** package. This vignette introduces simple 
concepts assocuated with R's object classes so that newcomers to this style of
...
* S3 compenents are accessed like normal list components
