...
#require(sp)
#la_cities_map <- sp::merge(la_SPDF, cities) 

la_SPDF@data <- full_join(la_SPDF@data, cities, by = c('city'))
...
# Note: Going to have to stop now. When I used sp:merge, I am left with the specific cities in the LA County (la_SPDF, cities). When printed, you don't see the "LA County" shape. Messed around a little bit with the la_SPDF filter and when I plotted, it looked like what I want. Full_joined with the cities df but dimensions were not matching. Maybe I need to fill the NA's? Will come back to this. 
